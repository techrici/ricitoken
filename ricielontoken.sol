...
/*
   #LIQ+#RFI+#SHIB+#DOGE = Rici	
   
   #RiciELon features:	
   5% fee auto add to the liquidity pool to locked forever when selling	
   5% fee auto distribute to all holders	
   99.9% Supply is burned by sending to top meme token smart contracts for marketing purpose.	
   
   Shina Inu Contract Address: 0x95ad61b0a150d79219dcf64e1e6cc01f0b64c4ce
    Magic Internet Money Contract Address: 0x99d8a9c45b2eca8864373a26d1459e3dff1e17f3
    Spell Token
...
contract RELon is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100 * 10**3 * 10**9 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "R ELon";
